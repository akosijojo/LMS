...
extension FeedViewController : UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.hideShowImageView(dataFile: self.data[indexPath.item].postAttachment, dataPoll: self.data[indexPath.item].pollData)
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        defaultHeight += (self.data[indexPath.item].pollData.count ?? 0) > 0 ? calculatePostDesc(text: "The description of poll") : 0
